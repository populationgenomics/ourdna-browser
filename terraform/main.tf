...
module "gnomad-browser-vpc" {
  source                  = "github.com/populationgenomics/tgg-terraform-modules//gnomad-vpc?ref=2-generalise-modules"
  # vpc_sub_module_source   = "github.com/populationgenomics/tgg-terraform-modules//vpc-with-nat-subnet?ref=2-generalise-modules"
...
module "gnomad-browser-infra" {
  source                                = "github.com/populationgenomics/tgg-terraform-modules//gnomad-browser-infra?ref=2-generalise-modules"
  # gke_sub_module_source                 = "github.com/populationgenomics/tgg-terraform-modules//private-gke-cluster?ref=2-generalise-modules"
